...
function getUrls(senha) {
  ...
  return [
    ...
    { nome: 'Pooler Session (porta 5432)', url: `postgresql://postgres.${PROJECT_REF}:${p}@aws-0-us-east-1.pooler.supabase.com:5432/postgres?connect_timeout=10` },
    { nome: 'Pooler Transaction (porta 6543)', url: `postgresql://postgres.${PROJECT_REF}:${p}@aws-0-us-east-1.pooler.supabase.com:6543/postgres?connect_timeout=10` },
  ];
}
